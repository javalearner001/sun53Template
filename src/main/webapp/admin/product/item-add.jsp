...
<div style="padding:10px 10px 10px 10px">
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td width="30%" align="center" bgColor="#f5fafe" class="ta_01">商品图片:</td>
	            <td>
	        ...
	        <tr>
	            <td width="30%" align="center" bgColor="#f5fafe" class="ta_01">商品描述:</td>
	            <td>
	                <textarea style="width:800px;height:100px;visibility:hidden;" name="desc"></textarea>
	            </td>
	        </tr>
	    </table>
