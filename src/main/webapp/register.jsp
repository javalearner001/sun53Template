	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form class="form-horizontal" id="myform" method="post" action="/register" style="margin-top: 5px;">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
							...
							<label class="radio-inline"> <input type="radio" name="sex" id="sex2" value="female">女
							</label>
